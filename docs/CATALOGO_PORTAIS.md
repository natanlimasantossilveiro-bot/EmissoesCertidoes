...
| 15 | Débitos Trabalhistas (TST) | PF/PJ | `tst.jus.br/certidao` (formulário real: `cndt-certidao.tst.jus.br`) | ✅ Automatizado e **validado de ponta a ponta** com captcha real — captcha de imagem simples (não reCAPTCHA/hCaptcha), sistema JSF/RichFaces antigo, PDF baixado com sucesso |
